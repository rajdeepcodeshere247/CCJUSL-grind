    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="entryLayers absolute scale-x-100 inset-0 h-full w-full origin-right z-20 bg-pink-600 will-change-transform" />
          <div className="entryLayers absolute scale-x-100 inset-0 h-full w-full origin-right z-10 bg-pink-300 will-change-transform" />
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-y-2 gap-x-4 text-[11px] text-white/80 font-euclid border-t border-white/10 pt-3 pointer-events-none">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-red-400">{event.prizePool}</span>
              </div>
              <div className="flex items-center gap-2">
