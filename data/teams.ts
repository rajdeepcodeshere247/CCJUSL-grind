...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Tech Team Member in Srijan'25 and '26",
    ],
  ...
  },
  {
    ...
    achievements: [
      ...
      "Reduced event costs by 20% through vendor negotiations",
      "Introduced transparent budget reporting system",
    ],
  ...
  },
  {
    ...
    achievements: [
      "Curated 100+ practice problems across difficulty levels",
      "Organized 4 mock ICPC rounds",
      "Mentored 30+ first-time competitive programmers",
    ],
  ...
  },
  {
    ...
    achievements: [
      "ICPC Asia Regional qualifier 2023 & 2024",
      "Delivered advanced graph theory masterclass",
      "Maintained club's CP resource repository",
    ],
    socials: { github: "#" },
  },
  ...
  // Development Team
  {
    ...
    achievements: [
      "Rebuilt club website with Next.js 15 & TypeScript",
      "Reduced page load time by 60% via optimization",
      "Introduced CI/CD pipeline for club projects",
    ],
    socials: { linkedin: "#", github: "#" },
  },
  {
    ...
    achievements: [
      "Designed and shipped fully responsive UI for club site",
      "Won internal design sprint with a dashboard prototype",
      "Implemented WCAG-compliant accessibility improvements",
    ],
    socials: { linkedin: "#", github: "#" },
  },
  {
